...
myPersevereCodeObj.term += 1
// myPersevereCodeObj.term++ (only adds 1)
...
mySelf.firstName = "Dessirae"

// Add a `lastName` property and set it to a string.
mySelf.lastName = "Mitchell"
...
//mySelf.fullName = obj.firstName + " " + obj.lastName
...
mySelf.address.push('1151 Cross Valley Cove')
mySelf.address.push('Memphis')
mySelf.address.push('Tennessee')
// obj.address.push("1234 Main St", "Memphis, TN", "38018")
